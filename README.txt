[h1]Extra Traditions - Remastered version[/h1]

The development version of this mod will be updated in real-time on [url=https://github.com/Lyther/MoreTradition---Reborn]GitHub[/url]. If you want to play the latest development rather than the stable version, you can get the latest commit using the [code single]git pull[/code] command on the GitHub repository.
...
The latest [url=https://steamcommunity.com/sharedfiles/filedetails/?id=2616955720]Extra Traditions mod[/url] has been updated and adapted to version 3.6, thanks to the adoption of some of my code by player [url=https://steamcommunity.com/profiles/76561198277755]"Star Haze"[/url]. This is an exciting event for a player who loves the Extra Traditions mod. The new Extra Traditions mod has improved almost all the exciting content, and it seems that no further updates are needed to adapt to new versions. Therefore, this mod will focus on improving the Extra Traditions mod experience.

The changes that have been adopted into the Extra Traditions mod will be removed from this mod.

[h2]Adjustments compared to the Extra Traditions mod[/h2]

[b]Artifact Actions[/b]
...
- Special Cultivation
  ...
  - [Added] Special Cultivation has added two new leader types to choose from: Legendary Leaders and Stunning Genius.
    - [b]Note: Unbalanced changes. The traits of genius leaders, legendary leaders, and stunning genius leaders are too strong under the situation of version 3.8's leader value collapse. These are meant for reference only. Players who pursue a sense of substitution can choose not to use Special Cultivation.[/b]
...
此MOD的开发版本将在[url=https://github.com/Lyther/MoreTradition---Reborn]GitHub[/url]进行实时更新，如果您想游玩最新的开发版本而非稳定版本，可以通过GitHub仓库的[code single]git pull[/code]获取最新的commit。

适配最新的3.8版本，如果您仍然在游玩3.7及以下版本，可以在GitHub中获得历史版本的推送记录，并手动还原至该版本。

最新的[url=https://steamcommunity.com/sharedfiles/filedetails/?id=2616955720]额外传统[/url]已经应对3.6版本进行了更新，并且感谢[url=https://steamcommunity.com/profiles/76561198277755]星劫[/url]大大采用了我的一部分代码，对于一个非常喜欢额外传统MOD的玩家来说实在是一件令人激动的事。新的额外传统MOD几乎完美地改进了所有令人兴奋的内容，似乎已经不再需要应对新版本进行特殊化的更新。因此，本MOD将会针对于额外传统MOD的体验改进。
...
* 特殊培养
  ...
  * [新增] 特殊培养可以选择两种新的领袖类型：传奇领袖和大放异彩的传奇天才。
    * [b]注意：不平衡的改动，天才领袖、传奇领袖、大放异彩的传奇天才在3.8原版领袖数值崩坏的情况下过于强势，仅供参考使用，追求代入感的玩家可以选择不使用特殊培养。[/b]
